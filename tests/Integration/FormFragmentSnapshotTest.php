...
TWIG);
        ...
        self::assertStringContainsString('data-ui-fragment="blocks.ext.combobox"', $html);
...
TWIG);
        ...
        self::assertStringContainsString('data-ui-fragment="blocks.ext.date-picker"', $html);
        self::assertStringContainsString('data-ui-fragment="blocks.ext.calendar"', $html);
