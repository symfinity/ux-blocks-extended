...
final class TableOfContentsTest extends ComponentTestCase
{
    ...
    public function rootHasBlocksExtFragmentAndStimulus(): void
    {
        ...
        $this->assertRootAttributes($html, 'table-of-contents', 'blocks.ext.table-of-contents');
        self::assertStringContainsString('data-controller="symfony--ux-blocks-extended--table-of-contents"', $html);
        self::assertStringContainsString('data-symfony--ux-blocks-extended--table-of-contents-scroll-target-value="#docs-content"', $html);
