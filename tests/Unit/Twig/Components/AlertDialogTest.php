...
final class AlertDialogTest extends ComponentTestCase
{
    ...
    public function rootHasBlocksExtFragment(): void
    {
        ...
        $this->assertRootAttributes($html, 'alert-dialog-enhanced', 'blocks.ext.alert-dialog-enhanced');
        self::assertStringContainsString('data-controller="symfony--ux-blocks-extended--alert-dialog"', $html);
    }
