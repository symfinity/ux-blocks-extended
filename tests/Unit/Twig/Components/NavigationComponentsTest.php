...
final class NavigationComponentsTest extends ComponentTestCase
{
    ...
    {
        return [
            'menubar' => ['Menubar', 'menubar', 'blocks.ext.menubar', 'menubar', []],
            'navigation-menu' => ['NavigationMenu', 'navigation-menu', 'blocks.ext.navigation-menu', 'navigation-menu', []],
            'sidebar' => ['Sidebar', 'sidebar', 'blocks.ext.sidebar', 'sidebar', ['side' => 'left']],
            'stacked-layout-interactive' => [
                'StackedLayoutInteractive',
                'stacked-layout-interactive',
                'blocks.ext.stacked-layout-interactive',
                'stacked-layout-interactive',
    ...
    public function rootHasBlocksExtFragment(
        ...
        self::assertStringContainsString(
            sprintf('data-controller="symfony--ux-blocks-extended--%s"', $controllerSlug),
            $html,
        );
    }
}
