...
export default class extends Controller {
    ...
    connect() {
        if (!this.hasInputTarget) {
            ...
            input.setAttribute('data-symfony--ux-blocks-extended--slider-target', 'input');
            input.setAttribute(
                'data-action',
                'input->symfony--ux-blocks-extended--slider#syncValue change->symfony--ux-blocks-extended--slider#syncValue keydown->symfony--ux-blocks-extended--slider#keydown',
            );
    ...
    syncValue() {
        ...
        this.element.dispatchEvent(
            new CustomEvent('ux-blocks-extended:slider-change', {
                bubbles: true,
