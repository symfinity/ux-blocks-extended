...
export default class extends Controller {
    ...
    connect() {
        ...
        this.element.addEventListener('ux-blocks-extended:calendar-select', this._onCalendarSelect);
    ...
    disconnect() {
        ...
        this.element.removeEventListener('ux-blocks-extended:calendar-select', this._onCalendarSelect);
    }
    ...
    _onCalendarSelect(event) {
        ...
        this.element.dispatchEvent(
            new CustomEvent('ux-blocks-extended:date-picker-change', {
                bubbles: true,
                detail: { date },
            }),
        );
