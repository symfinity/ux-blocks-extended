...
export default class extends Controller {
    ...
    selectDay(event) {
        ...
        this.element.dispatchEvent(
            new CustomEvent('ux-blocks-extended:calendar-select', {
                bubbles: true,
                detail: { date: iso },
            }),
        );
    ...
    _renderMonth() {
        ...
        for (let day = 1; day <= daysInMonth; day += 1) {
            ...
            button.setAttribute('data-symfony--ux-blocks-extended--calendar-target', 'day');
            button.setAttribute(
                'data-action',
                'click->symfony--ux-blocks-extended--calendar#selectDay',
            );
